...
/**
 * This program calculates the square root of a positive number using Newton's
 * method, ensuring a relative error of less than 0.01%. The user can calculate
 * multiple square roots in a single session.
 *
 * @author Jeng Zhuang
 *
 */
