...
public final class NaturalNumberStaticOps {
    ...
    private static void printWithCommas(NaturalNumber n, SimpleWriter out) {
        ...
        if (copy.compareTo(ONE_THOUSAND) < 0) {
            ...
            //for (int i = 0; i < 3; i++) {
            //   int digit = copy.divideBy10();
            //   remainder.multiplyBy10(digit);
            // }
            //printWithCommas(copy, out);
            //out.print(',');

            //int one = remainder.divideBy10();
            //int ten = remainder.divideBy10();
            //int hundred = remainder.divideBy10();

            // out.print(hundred);
            //out.print(ten);
            //out.print(one);

            int oneDig = n.divideBy10();
            int tenDig = n.divideBy10();
            int thouDig = n.divideBy10();

            printWithCommas(copy, out);

            out.print("," + thouDig + tenDig + oneDig);

            n.multiplyBy10(thouDig);
            n.multiplyBy10(tenDig);
            n.multiplyBy10(oneDig);
        }
