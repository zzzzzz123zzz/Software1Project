...
public final class Coinchange3 {
    ...
    /**
     * Calculates the number of coins needed for each denomination to make the
     * given change.
     *
     * @param cents
     *            The amount of change (in cents).
     * @param denominations
     *            Array of coin denominations (e.g., {100, 50, 25, 10, 5, 1}).
     * @return An array of coin counts for each denomination.
     */
    private static int[] coinCountsToMakeChange(int cents, int[] denominations) {
